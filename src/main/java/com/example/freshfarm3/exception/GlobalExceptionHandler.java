...
public class GlobalExceptionHandler {
    ...
    // UnauthorizedException's own javadoc says it maps to 403, but there was
    // no handler for it here — it was silently falling through to the
    // generic RuntimeException handler below and always returning 400.
